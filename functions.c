/*
 * Funciones para transcripcion de codigo ADA a codigo Mips
 * Elaborado por Adrian Villanueva y Pablo Ferrer
 * Para la asignatura de Compiladores
 *
 */
...
void mipsVar_insert_mips_variable_declaration(struct MipsVariables *mipsVariables,
                                              ...
                                              char *val2, float val3, double val4) {
    int i = 0;
    int encontrado = 0;
...
void mipsIns_math_operations_ASG(struct MipsVariables *mipsVariables, char *filename, char operation, char *variable1,
    ...
    if (index_1 != -500 && index_2 != -500) {
        if (operation == '+') {
            mipsIns_load_instruction_variable(mipsVariables, filename, index_1);
            mipsIns_load_instruction_variable(mipsVariables, filename, index_2);
            ...
            mipsIns_load_instruction_variable(mipsVariables, filename, index_1);
            mipsIns_load_instruction_variable(mipsVariables, filename, index_2);
            mipsIns_load_instruction_variable(mipsVariables, filename, index_3);
...
void mipsIns_while_var(struct MipsVariables mipsVariables, char *varname) {


}

void mipsIns_while_noVar() {
